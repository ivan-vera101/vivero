        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <div class="navbar-brand">
              <a href="index"><h1><span>OPTI</span>VIVERO</h1></a>
            </div>
          </div>
          ...
          <div class="navbar-collapse collapse">
            <div class="menu">
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="{{ url('/register') }}">Registrate</a></li>
                <li role="presentation"><a href="portfolio.html">Contactanos</a></li>
               <!-- <li role="presentation"><a href="blog.html">Blog</a></li>-->
                <li role="presentation"><a href="{{ url('/login') }}">Iniciar sesion</a></li>
            ...
            <div class="row slide-margin">
              <div class="col-sm-6">
                <div class="carousel-content">
                  <h2 class="animation animated-item-1">BIEN<span>VENIDO</span></h2>
                  <p class="animation animated-item-2">Registrate para que disfrutes de nuestra gran variedad opciones y privilegios para tu vivero. </p>
                  <a class="btn-slide animation animated-item-3" href="{{ url('/register') }}">Registrate</a>
                </div>
              </div>
  ...
  <div class="lates">
    <div class="container">
      ...
      <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
        ...
        <h3>Nuevos injertos de pimentones</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus interdum erat libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque libero, pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque libero,
          pulvinar tincidunt leo consectetur eget. Curabitur lacinia pellentesque
        </p>
      </div>
